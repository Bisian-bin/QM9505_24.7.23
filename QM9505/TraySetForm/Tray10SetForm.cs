...
{
    public partial class Tray10SetForm : Form
    {
        DataGrid dataGrid = new DataGrid();
        TXT myTXT = new TXT();
        public Tray10SetForm()
        {
            InitializeComponent();
        }

        private void Tray10SetForm_Load(object sender, EventArgs e)
        {
            DataGridINI();

            //1#Down
            string[] strDown1 = myTXT.ReadTXT(Application.StartupPath + @"\Data\TCPModel\37\tray");
            myTXT.ReadTxtToDataGridMethod1(Test1DataGrid, strDown1);

            //2#Down
            string[] strDown2 = myTXT.ReadTXT(Application.StartupPath + @"\Data\TCPModel\38\tray");
            myTXT.ReadTxtToDataGridMethod1(Test2DataGrid, strDown2);

            //3#Down
            string[] strDown3 = myTXT.ReadTXT(Application.StartupPath + @"\Data\TCPModel\39\tray");
            myTXT.ReadTxtToDataGridMethod1(Test3DataGrid, strDown3);

            //4#Down
            string[] strDown4 = myTXT.ReadTXT(Application.StartupPath + @"\Data\TCPModel\40\tray");
        ...
        private void Test1DataGrid_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            myTXT.WriteTxt(strDown1, Application.StartupPath + @"\Data\TCPModel\37\tray");
        }
        ...
        private void Test2DataGrid_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            myTXT.WriteTxt(strDown1, Application.StartupPath + @"\Data\TCPModel\38\tray");
        }
        ...
        private void Test3DataGrid_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            myTXT.WriteTxt(strDown1, Application.StartupPath + @"\Data\TCPModel\39\tray");
        }
        ...
        private void Test4DataGrid_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            myTXT.WriteTxt(strDown1, Application.StartupPath + @"\Data\TCPModel\40\tray");
        }
