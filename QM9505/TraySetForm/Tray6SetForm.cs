...
{
    public partial class Tray6SetForm : Form
    {
        ...
        private void Tray6SetForm_Load(object sender, EventArgs e)
        {
            DataGridINI();

            //1#Down
            string[] strDown1 = myTXT.ReadTXT(Application.StartupPath + @"\Data\TCPModel\21\tray");
            myTXT.ReadTxtToDataGridMethod1(Test1DataGrid, strDown1);

            //2#Down
            string[] strDown2 = myTXT.ReadTXT(Application.StartupPath + @"\Data\TCPModel\22\tray");
            myTXT.ReadTxtToDataGridMethod1(Test2DataGrid, strDown2);

            //3#Down
            string[] strDown3 = myTXT.ReadTXT(Application.StartupPath + @"\Data\TCPModel\23\tray");
            myTXT.ReadTxtToDataGridMethod1(Test3DataGrid, strDown3);

            //4#Down
            string[] strDown4 = myTXT.ReadTXT(Application.StartupPath + @"\Data\TCPModel\24\tray");
        ...
        private void Test1DataGrid_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            myTXT.WriteTxt(strDown1, Application.StartupPath + @"\Data\TCPModel\21\tray");
        }
        ...
        private void Test2DataGrid_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            myTXT.WriteTxt(strDown1, Application.StartupPath + @"\Data\TCPModel\22\tray");
        }
        ...
        private void Test3DataGrid_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            myTXT.WriteTxt(strDown1, Application.StartupPath + @"\Data\TCPModel\23\tray");
        }
        ...
        private void Test4DataGrid_CellMouseUp(object sender, DataGridViewCellMouseEventArgs e)
        {
            ...
            myTXT.WriteTxt(strDown1, Application.StartupPath + @"\Data\TCPModel\24\tray");
        }
